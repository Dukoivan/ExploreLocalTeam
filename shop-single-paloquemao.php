...
<section class="bg-light"> 
    <!-- Sección con fondo claro que contiene el contenido principal -->
    <div class="container pb-5"> 
        <!-- Contenedor con padding en la parte inferior de 5 (pb-5) -->
        <div class="row"> 
            <!-- Fila para organizar el contenido en columnas -->
            <div class="col-lg-5 mt-5"> 
                <!-- Columna que ocupa 5 de 12 espacios en pantallas grandes (lg) con un margen superior de 5 -->
                <div class="card mb-3"> 
                    <!-- Tarjeta con un margen inferior de 3 -->
                    <img class="card-img img-fluid" src="assets/img/paloquemao1.jpg" alt="Card image cap" id="product-detail"> 
                    <!-- Imagen fluida dentro de la tarjeta -->
                </div>
                <div class="row">
                    <!--Start Controls-->
                    <div class="col-1 align-self-center"> 
                        <!-- Columna de 1 espacio que se alinea verticalmente al centro -->
                        <a href="#multi-item-example" role="button" data-bs-slide="prev"> 
                            <!-- Enlace para navegar hacia el slide anterior en el carrusel -->
                            <i class="text-dark fas fa-chevron-left"></i> 
                            <!-- Icono de flecha izquierda de color oscuro -->
                    ...
                    <div id="multi-item-example" class="col-10 carousel slide carousel-multi-item" data-bs-ride="carousel"> 
                        <!-- Carrusel que ocupa 10 espacios, con múltiples elementos por slide -->
                        <!--Start Slides-->
                        <div class="carousel-inner product-links-wap" role="listbox"> 
                            <!-- Contenedor para los elementos del carrusel -->

                            <!--First slide-->
                            <div class="carousel-item active"> 
                                <!-- Primer elemento del carrusel que está activo -->
                                <div class="row"> 
                                    <!-- Fila interna para organizar las imágenes en columnas -->
                                    <div class="col-4"> 
                    ...
                    <!--Start Controls-->
                    <div class="col-1 align-self-center"> 
                        <!-- Columna de 1 espacio con control para avanzar en el carrusel -->
                        <a href="#multi-item-example" role="button" data-bs-slide="next"> 
                            <!-- Enlace para ir al siguiente slide del carrusel -->
                            <i class="text-dark fas fa-chevron-right"></i> 
                            <!-- Icono de flecha derecha de color oscuro -->
            ...
            <div class="col-lg-7 mt-5"> 
                <!-- Columna de 7 espacios en pantallas grandes con margen superior -->
                <div class="card">
                    <!-- Tarjeta -->
                    <div class="card-body"> 
                        <!-- Cuerpo de la tarjeta -->
                        <h1 class="h2">Plaza de Mercado Paloquemao</h1> 
                        <!-- Título principal en la tarjeta -->
                        
                        <p class="py-2"> 
                            <!-- Párrafo con padding vertical de 2 -->
                            ...
                            <!-- Texto de calificación y comentarios -->
                        </p>
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item">
                                ...
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3101.7605307738263!2d-74.08883865!3d4.6151978499999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f996fd7eaf9b3%3A0xbfadb04d8702bc4a!2sPaloquemao%2C%20Los%20M%C3%A1rtires%2C%20Bogot%C3%A1!5e1!3m2!1ses-419!2sco!4v1728665339884!5m2!1ses-419!2sco" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                <!-- Iframe para mostrar el mapa de Google con la ubicación -->
                            </li>
                        </ul>

                        <h5 style="color: green;">Descripcion:</h5> 
                        <!-- Título para la descripción -->
                        <p>La Plaza de Mercado de Paloquemao es un lugar emblemático... </p> 
                        <!-- Párrafo descriptivo sobre la plaza -->

                        <h5 style="color: green;">Servicios:</h5> 
                        <!-- Título para los servicios -->
                        <p>Queremos ofrecerte la mejor experiencia... </p> 
                        <!-- Descripción de los servicios disponibles -->
                        <ul class="list-unstyled pb-3">
                            <!-- Lista no ordenada y sin estilos -->
                            <li></li> 
                            <li></li> 
                            <li></li> 
                            <li></li> 
